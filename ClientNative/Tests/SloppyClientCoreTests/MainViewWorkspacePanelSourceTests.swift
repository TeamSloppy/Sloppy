...
struct MainViewWorkspacePanelSourceTests {
    ...
    func desktopMainViewKeepsWorkspaceInsideTheCurrentWindow() throws {
        ...
        #expect(mainView.contains("private var workspacePanelModePicker: some View"))
        #expect(mainView.contains("Label(\"Browser\", systemImage: \"safari\")"))
        #expect(mainView.contains("Label(\"Files\", systemImage: \"folder\")"))
