...
struct WorkspaceEnvironmentPanelSourceTests {
    ...
    func environmentModeLoadsTypedData() throws {
        ...
        #expect(panelViewModel.contains("availableCodeReviews"))
        ...
        #expect(panelViewModel.contains("fetchCodeReviews"))
        #expect(panelViewModel.contains("matchingCodeReview"))
        #expect(environmentView.contains("review.providerName"))
        #expect(environmentView.contains("No open review"))
