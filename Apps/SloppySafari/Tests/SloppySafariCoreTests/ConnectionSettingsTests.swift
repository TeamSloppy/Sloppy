import Foundation
import Testing
@testable import SloppySafariCore
...
func connectionSettingsStoreNormalizesDecodedSettingsOnInit() throws {
    ...
    userDefaults.set(encoded, forKey: "SloppySafari.connectionSettings")
...
func connectionSettingsStoreSavesNormalizedSettings() throws {
    ...
    let data = try #require(userDefaults.data(forKey: "SloppySafari.connectionSettings"))
...
private func testUserDefaults() throws -> UserDefaults {
    let suiteName = "SloppySafariCoreTests.\(UUID().uuidString)"
